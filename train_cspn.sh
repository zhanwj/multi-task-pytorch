...
CUDA_VISIBLE_DEVICES=1,2 /home/zhanwj/Desktop/pyTorch/anaconda3/envs/pytorch/bin/python  -u tools/train_net_cspn.py --dataset cityscapes_semseg_train \
    --cfg configs/baselines/e2e_segdisp-R-50_cspn_1x.yaml \
    --bs 4 --nw 4  --device_ids 1 2 \
