...
__all__ = ['ResNeXt', 'resnext101','resnext101_64'] # support resnext 101
...
#     return model
def load_url(url, model_dir='/home/zhanwj/Desktop/pyTorch/Detectron.pytorch/', map_location=None):
    if not os.path.exists(model_dir):
        os.makedirs(model_dir)
    filename = 'lib/datasets/pretrain_model/resnext101_32x4d-29e315fa.pth'
...
def Originalload_url(url, model_dir='./pretrained', map_location=None):
    if not os.path.exists(model_dir):
        os.makedirs(model_dir)  
