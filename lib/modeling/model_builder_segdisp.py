        ...
        if self.training: # training
            ...
            if cfg.SEM.DECODER_TYPE.endswith('deepsup'):
                ...
                if not cfg.DISP.USE_DEEPSUP:   
                    ...
                    loss_deepsup_disp, _ = self.disp_loss(pred_deepsup_disp, label_info)
