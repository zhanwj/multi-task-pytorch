...
def argument():
    ...
    parser.add_argument('--dataset', dest='dataset', help='give a dataset name', default='wq', type=str)
    ...
    parser.add_argument('--config', dest='config', help='which file to restore', default='./configs/baselines/e2e_pspnet-X101_32x4d_2x.yaml', type=str)
    ...
    # parser.add_argument('--network', dest='network', help='network name', default='Generalized_SEMSEG', type=str)
    parser.add_argument('--pretrained_model', dest='premodel', help='path to pretrained model', default='./output/ubernet_xt101_32x4d_multiscale_poly_30epochs_720/e2e_pspnet-X101_32x4d_2x/Dec16-22-48-02_localhost.localdomain/ckpt/model_0_3332.pth', type=str)
...
class TestNet(object):
    ...
    def load_segdisp_image(self, args):
        ...
        image_L = cv2.imread(os.path.join(args.data_dir, args.dataset, img_L))
        image_R = cv2.imread(os.path.join(args.data_dir, args.dataset, img_R))
