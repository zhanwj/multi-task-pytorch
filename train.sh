...
CUDA_VISIBLE_DEVICES=3,4 /home/zhanwj/Desktop/pyTorch/anaconda3/envs/pytorch/bin/python  -u tools/train_net.py --dataset cityscapes \
    --cfg configs/baselines/e2e_segdisp-R-50_CRL_1x.yaml \
    --bs 2 --nw 2  --device_ids 3 4 \
