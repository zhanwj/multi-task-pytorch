        ...
        for args.epoch in range(args.start_epoch, args.start_epoch + args.num_epochs):
            ...
            for args.step, input_data in zip(range(args.start_iter, iters_per_epoch), dataloader):
                ...
                if(saveNetStructure):
                    saveNetStructure=False
                    with netStructure:
                        netStructure.add_graph(maskRCNN,**input_datax)
                    print("network structure had been drew")
                ...
                #print("GPU MEMORIES UESD:{} MB(BEFORE BACKWARD)".format(meminfo.used/1024**2))
                #print("GPU MEMORIES FREE:{} MB(BEFORE BACKWARD)\n".format(meminfo.free/1024**2))
                ...
                #print("GPU MEMORIES UESD:{} MB(AFTER WEIGHTS UPDATE)".format(meminfo.used/1024**2))
                #print("GPU MEMORIES FREE:{} MB(AFTER WEIGHTS UPDATE)\n".format(meminfo.free/1024**2))
