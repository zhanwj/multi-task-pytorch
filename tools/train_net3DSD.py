...
from modeling.model_builder_PSP3D import DispSeg, NetStructure
            ...
            for args.step, input_data in zip(range(args.start_iter, iters_per_epoch), dataloader):
                ...
                if cfg.DISP.DISP_ON:
                    ...
                    if cfg.SEM.DECODER_TYPE.endswith('3Ddeepsup'):
                        ...
                        input_data['semseg_scans'] = torch.arange(0,
                                cfg.MODEL.NUM_CLASSES).long().view(1, cfg.MODEL.NUM_CLASSES, 1, 1).repeat(args.batch_size,1,1,1)
