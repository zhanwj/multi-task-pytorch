...
CUDA_VISIBLE_DEVICES=2,3 /home/zhanwj/Desktop/pyTorch/anaconda3/envs/pytorch/bin/python  -u tools/train_net_psp_pretrained_test.py --dataset cityscapes \
    --cfg configs/baselines/e2e_ubernet-SE_R101_2x.yaml \
