...
def tensor_data_to_pred_colors(tensor_data, net):
    out = net.forward([Variable(tensor_data).cuda()])
...
def main():
    ...
    dataloader = dataloader1(batch_size, len_gpus)
